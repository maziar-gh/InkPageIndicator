...
public class InkPageIndicator extends View
  ...
  public InkPageIndicator(Context context, AttributeSet attrs, int defStyle) {
    ...
    // Load attributes
    final TypedArray a =
        getContext().obtainStyledAttributes(attrs, R.styleable.InkPageIndicator, defStyle, 0);
    ...
    animDuration =
        (long) a.getInteger(R.styleable.InkPageIndicator_animationDuration, DEFAULT_ANIM_DURATION);
    animHalfDuration = animDuration / 2;
    unselectedColour =
        a.getColor(R.styleable.InkPageIndicator_pageIndicatorColor, DEFAULT_UNSELECTED_COLOUR);
    selectedColour =
        a.getColor(R.styleable.InkPageIndicator_currentPageIndicatorColor, DEFAULT_SELECTED_COLOUR);
  ...
  public void setViewPager(ViewPager viewPager, final int pageCount) {
    this.viewPager = viewPager;
    viewPager.addOnPageChangeListener(this);
  ...
  private void setCurrentPageImmediate() {
    ...
    if (dotCenterX != null && dotCenterX.length > 0 && (moveAnimation == null
   ...
   */
  private Path getUnselectedPath(int page, float centerX, float nextCenterX, float joiningFraction,
